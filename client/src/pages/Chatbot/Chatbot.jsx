...
import { Button, Card, Textarea, Spinner } from "@nextui-org/react";
import { ArrowDown, Send, User, Bot } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen w-full bg-background overflow-hidden font-Poppins">
      ...
      <div className="z-10 flex items-center justify-center flex-col h-full mt-5">
        <Card className={`w-full max-w-4xl h-[80vh] flex flex-col backdrop-blur-[3px] bg-slate-300/5 border ${isDarkMode ? 'border-gray-800' : 'border-gray-300'}`}>
