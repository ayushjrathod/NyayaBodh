...
const mockLaws = [
    { id: 1, title: "Criminal Code", description: "Comprehensive legislation covering criminal offenses and procedures.", type: "code", content: "Long text content about the Criminal Code...", pdfUrl: "/criminal-code.pdf" },
    { id: 2, title: "Civil Procedure Rules", description: "Rules governing civil litigation processes.", type: "rules", content: "Detailed content about Civil Procedure Rules...", pdfUrl: null },
    { id: 3, title: "Environmental Protection Act", description: "Legislation for environmental conservation and sustainable development.", type: "act", content: "In-depth content about the Environmental Protection Act...", pdfUrl: "/environmental-act.pdf" },
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                {filteredLaws.map(law => (
                    ...
                    >
                        ...
                        <Chip color="primary" variant="flat">{law.type}</Chip>
                    </Card>
                ))}
            </div>
